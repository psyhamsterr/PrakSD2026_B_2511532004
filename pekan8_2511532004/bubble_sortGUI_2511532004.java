...
import pekan7_2511532004.insertiongui_2511532004;

public class bubble_sortGUI_2511532004 extends JFrame {
	 ...
	 * Create the frame.
	 */
	public bubble_sortGUI_2511532004() {
	...
	private void setArrayFromInput_2004() {
	    ...
	    for (int k_2004 = 0; k_2004 < array_2004.length; k_2004++) {
	        ...
	        labelArray_2004[k_2004].setOpaque(true);
	        labelArray_2004[k_2004].setBackground(Color.WHITE);
	        labelArray_2004[k_2004].setBorder(BorderFactory.createLineBorder(Color.BLACK));
	        labelArray_2004[k_2004].setPreferredSize(new Dimension(50, 50));
	        labelArray_2004[k_2004].setHorizontalAlignment(SwingConstants.CENTER);
	...
	private void performStep_2004() {
        if (!sorting_2004 || i_2004 >= array_2004.length - 1) {
            sorting_2004 = false;
            stepButton_2004.setEnabled(false);
            JOptionPane.showMessageDialog(this, "Sorting selesai!");
            return;
        }
        resetHighlights_2004();
        StringBuilder stepLog_2004 = new StringBuilder();
        labelArray_2004[j_2004].setBackground(Color.CYAN);
        labelArray_2004[j_2004 + 1].setBackground(Color.CYAN);
        if (array_2004[j_2004] > array_2004[j_2004 + 1]) {
            // Swap
            int temp_2004 = array_2004[j_2004];
            array_2004[j_2004] = array_2004[j_2004 + 1];
            array_2004[j_2004 + 1] = temp_2004;
            labelArray_2004[j_2004].setBackground(Color.RED);
            labelArray_2004[j_2004 + 1].setBackground(Color.RED);
            stepLog_2004.append("Langkah ").append(stepCount_2004).append(": Menukar elemen ke-")
                    .append(j_2004).append(" (").append(array_2004[j_2004 + 1]).append(") dengan ke-")
                    .append(j_2004 + 1).append(" (").append(array_2004[j_2004]).append(")\n");
        } else {
            stepLog_2004.append("Langkah ").append(stepCount_2004).append(": Tidak ada pertukaran antara ke-")
                    .append(j_2004).append(" (").append(array_2004[j_2004]).append(") dan ke-")
                    .append(j_2004 + 1).append(" (").append(array_2004[j_2004 + 1]).append(")\n");
        }
        stepLog_2004.append("Hasil: ").append(arrayToString_2004(array_2004)).append("\n\n");
        stepArea_2004.append(stepLog_2004.toString());
        updateLabels_2004();
        j_2004++;
        if (j_2004 >= array_2004.length - i_2004 - 1) {
            j_2004 = 0;
            i_2004++;
        }
        stepCount_2004++;
        if (i_2004 >= array_2004.length - 1) {
            sorting_2004 = false;
            stepButton_2004.setEnabled(false);
            JOptionPane.showMessageDialog(this, "Sorting selesai!");
        }
    ...
    private void resetHighlights_2004() {
        for (JLabel label_2004 : labelArray_2004) {
            label_2004.setBackground(Color.WHITE);
        }
    }
    ...
    private String arrayToString_2004(int[] arr_2004) {
        ...
        for (int k_2004 = 0; k_2004 < arr_2004.length; k_2004++) {
            ...
            if (k_2004 < arr_2004.length - 1) sb_2004.append(", ");
        }
